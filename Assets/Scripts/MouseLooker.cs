...
public class MouseLooker : MonoBehaviour {
    ...
    public bool DoubleRot = false;
	
	// internal private variables
	private Quaternion _characterTargetRot;
    private Quaternion _characterTargetDoubleRot;
	...
	public void LookRotation()
	{
        ...
        _characterTargetDoubleRot = _characterTargetRot * _cameraTargetRot;
		...
		else if(!DoubleRot) // not smooth, so just jump
		{
        ...
        {
            _transform.localRotation = _characterTargetDoubleRot;
        }
	}
